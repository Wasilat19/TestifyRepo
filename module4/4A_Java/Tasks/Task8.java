...
public class Task8 {
    public static void main(String[] args) {
        ...
        System.out.print("For how long do you want to run this (in years): ");
        double time = amountInput.nextDouble();

        double simpleInterest = (principal * rate * time) / 100;

        System.out.println("Your Simple Interest for the period of " + time+" years" +" at " + rate+"% " + " is " + simpleInterest);
