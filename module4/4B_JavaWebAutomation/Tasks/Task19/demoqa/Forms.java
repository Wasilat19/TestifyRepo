...
public class Forms {
    ...
    public void formsPage() throws InterruptedException {
        ...
        WebElement formsTile = driver.findElement(By.xpath("//h5[contains(text(),'Forms')]"));
        formsTile.click();
        Thread.sleep(3000);
    }

    @Test(priority = 2)
    public void assertForms(){

        // Assert that you are on the Forms page
        WebElement formsHeader = driver.findElement(By.xpath("//body/div[@id='app']/div[1]/div[1]/div[1]/div[1]"));
        String expectedHeaderText = "Forms";
        String actualHeaderText = formsHeader.getText();
        System.out.println(actualHeaderText + " page------");
        Assert.assertEquals(actualHeaderText, expectedHeaderText, "----This is not the Forms page");
    }
